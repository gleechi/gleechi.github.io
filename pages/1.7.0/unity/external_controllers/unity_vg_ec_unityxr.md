...
permalink: unity_vg_ec_unityxr.1.7.0.html
...
If these requirements are met, you will be able to use the **VG_CP_Unity.UnityXR** controller profile to setup your [MyVirtualGrasp](unity_component_myvirtualgrasp.1.7.0.html#profile) configuration (otherwise an error will appear on the console).
