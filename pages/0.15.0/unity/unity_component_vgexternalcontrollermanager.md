...
permalink: unity_component_vgexternalcontrollermanager.0.15.0.html
folder: mydoc
---
...
It should be used in any VG_MainScript, such as [MyVirtualGrasp.cs](unity_component_myvirtualgrasp.0.15.0.html), where it is initialized after the VG_Controller itself initialized:
...
* [VG_EC_MouseHand](unity_vg_ec_mousehand.0.15.0.html) for Mouse control.
* [VG_EC_UnityXRHand](unity_vg_ec_unityxrhand.0.15.0.html) for all XR controllers that are supported through the [UnityXR](https://docs.unity3d.com/Manual/XR.0.15.0.html) API.
* [VG_EC_UnityInteractionHand](unity_vg_ec_unityinteractionhand.0.15.0.html) for all XR controllers that are supported through the [Unity XR Interaction Toolkit](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@2.0/manual/xr-controller-action-based.html) API.
* [VG_EC_SteamHand](unity_vg_ec_steamhand.0.15.0.html) for all XR controllers that are supported through [SteamVR](https://valvesoftware.github.io/steamvr_unity_plugin/index.html) API.
* [VG_EC_OculusHand](unity_vg_ec_oculushand.0.15.0.html) for Oculus Finger Tracking which is supported through the [Oculus](https://developer.oculus.com/downloads/package/unity-integration/) API.
* [VG_EC_LeapHand](unity_vg_ec_leaphand.0.15.0.html) for LeapMotion controller which is supported through the [Ultraleap](https://developer.leapmotion.com/unity) API.
* [VG_EC_GenericHand](unity_vg_ec_generichand.0.15.0.html) as a fallback solution.
