...
permalink: unity_component_vghandvisualizer.0.15.0.html
folder: mydoc
---
...
The MonoBehavior script exemplifies how to use the VG API functions for accessing specific bones / elements of the hands, such as [VG_Controller.GetBone()](virtualgrasp_unityapi.0.15.0.html#getbone) and [VG_Controller.GetFingerBone()](virtualgrasp_unityapi.0.15.0.html#getfingerbone).
