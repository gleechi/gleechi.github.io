...
permalink: unity_vg_ec_leaphand.0.9.7.html
...
Please refer to [External Controllers](unity_component_vgexternalcontrollermanager.0.9.7.html) for the definition of an external controller for VG.
 ...
 * You have the corresponding [LeapMotion SDK](https://developer.leapmotion.com/sdk-leap-motion-controller/) installed on your computer.
 ...
 After this, use the "LEAP_EXT" option to [AutoSetup](unity_component_myvirtualgrasp.0.9.7.html#autosetup) your VG configuration.
