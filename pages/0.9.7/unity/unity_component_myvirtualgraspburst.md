...
permalink: unity_component_myvirtualgraspburst.0.9.7.html
folder: mydoc
---
...
In contrast to [MyVirtualGrasp](unity_component_myvirtualgrasp.0.9.7.html), this component uses Burst Jobs to isolate VG updates on seperate threads.
...
1. [IsolatedUpdateDataIn](virtualgrasp_unityapi.0.9.7.html#isolatedupdatedatain)
2. [IsolatedUpdate](virtualgrasp_unityapi.0.9.7.html#isolatedupdate)
3. [IsolatedUpdateDataOut](virtualgrasp_unityapi.0.9.7.html#isolatedupdatedataout)
