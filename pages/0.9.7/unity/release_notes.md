...
permalink: release_notes.0.9.7.html
...
* GraspStudio optimized and extended (see [VG_GraspStudio](unity_component_vggraspstudio.0.9.7.html)).
...
* New VG_BakingClient to support CABVG2 cloud baking service (stay tuned for update of [VG_BakingClient](unity_component_vgbakingclient.0.9.7.html))
...
* [ChangeObjectJoint](virtualgrasp_unityapi.0.9.7.html#changeobjectjoint) fixed the bug that made new_screwRate input with no effect. 
...
* VG_DebugSettings modified. EditMode Save Debug Files for Current Editor Scene ⚠️. Read more on [Debug Files](debug_files.0.9.7.html).
...
* VG_GraspStudio allows deleting grasps. To delete a grasp, you have to "double-disable" it. Read more on [VG_GraspStudio](unity_component_vggraspstudio.0.9.7.html).
* VG_Recorder extended with example to call new VG_Controller.GetReplayStartWristPose().

##### API Changes:

* [SetAvatarActive](virtualgrasp_unityapi.0.9.7.html#setavataractive) added to set avatar in/active (i.e. sensor control and mesh visualization).
* [GetReplayStartWristPose](virtualgrasp_unityapi.0.9.7.html#getreplaystartwristpose) added to return starting wrist poses of a recording, and check [how to query start pose page](unity_component_vgrecorder.0.9.7.html#how-to-query-start-pose-of-hand) to learn to use it.
...
* ⚠️ IMPORTANT SDK and Bake have been separated:
    ...
    * Read more on [VG_BakingClient](unity_component_vgbakingclient.0.9.7.html) (when updated).
