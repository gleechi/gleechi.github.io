...
permalink: unity_component_vgpostanimator.0.9.7.html
folder: mydoc
---
...
during grasping by adding a listener to the [VG_Controller.OnPostUpdate](virtualgrasp_unityapi.0.9.7.html#onpostupdate) event.
