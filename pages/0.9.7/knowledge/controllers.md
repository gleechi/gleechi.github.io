...
permalink: controllers.0.9.7.html
folder: knowledge
toc: true
---
## Background
...
See [AutoSetup & Sensors](unity_component_myvirtualgrasp.0.9.7.html#autosetup--sensors) to learn how to setup your sensors in Unity. 
...
For Unity, the basic VG_ExternalController "UnityXR" is using Unity's [UnityXR](https://docs.unity3d.com/2019.1/Documentation/Manual/xr_input.0.9.7.html) API to provide the wrist pose and a trigger signal to VG.
