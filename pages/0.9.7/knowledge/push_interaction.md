...
permalink: push_interaction.0.9.7.html
folder: knowledge
toc: true
---
...
VirtualGrasp not only provides solutions to [grasp interaction](grasp_interaction.0.9.7.html#grasp-interaction), 
...
VirtualGrasp provides a solution to make push interaction setup easier and intuitive through [object articulation](object_articulation.0.9.7.html#object-articulation), with and without relying on physical simulations.

{% include callout.html content="Most important concepts relevant to push interaction are explained in [object articulation](object_articulation.0.9.7.html#object-articulation) page." %}
...
VirtualGrasp also supports push through physics, by seamlessly integrating VG's [object articulation](object_articulation.0.9.7.html#object-articulation) feature with the physical simulations already existing 
...
* set up the physical properties for the hand. In Unity, VirtualGrasp automatically setup the hand physical properties (RigidBody and Colliders) if you enable **Physical** avatars in [Sensors](unity_component_myvirtualgrasp.0.9.7.html#sensors) (see image below).
...
To help you set up the push object with physics, most of the [object articulation](object_articulation.0.9.7.html#object-articulation) parameters that applies to without physics situation also will take effect, with very few exceptions:
