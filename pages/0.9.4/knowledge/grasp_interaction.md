...
* there is no dependency on accurate finger tracking controllers (see [controllers](controllers.0.9.4.html)), and
...
To create natural-looking {% include tooltip.html tooltip="GraspConfiguration" text="grasp configurations" %} during {% include tooltip.html tooltip="GraspSynthesisMethod" text="grasp synthesis" %}, we need to [bake the object](object_baking.0.9.4.html#object-baking).
...
[grasp studio](unity_component_vggraspstudio.0.9.4.html#grasp-studio) can be used to add grasps into database through DG. 
...
To learn more details on how to setup your objects' grasp interaction in practice, please see [VG_Interactable](unity_component_vginteractable.0.9.4.html#unity-component-vginteractable).
