...
version: 0.9.4
permalink: unity_vgonboarding_task1.0.9.4.html
folder: mydoc
---
...
* How to determine when light should be on or off (use [GetObjectJointState](virtualgrasp_unityapi.0.9.4.html#getobjectjointstate) function)?
* More systemtic understanding can be obtained in [push interaction](push_interaction.0.9.4.html#background).
...
````
is the unity scene showing how [VG_Articulation](unity_component_vgarticulation.0.9.4.html) component is used to setup this object's articulation settings.
...
````
is the script showing how to use API function [GetObjectJointState](virtualgrasp_unityapi.0.9.4.html#getobjectjointstate) to get the object's {% include tooltip.html tooltip="JointState" text="joint state" %} in order to determine when the light is on or off. 
