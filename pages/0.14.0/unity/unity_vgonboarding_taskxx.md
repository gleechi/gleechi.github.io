...
permalink: unity_vgonboarding_taskxx.0.14.0.html
folder: mydoc
---
...
* Use [VG_GraspStudio](unity_component_vggraspstudio.0.14.0.html#grasp-studio) to create a primary grasp on **scissor** to be suitable for the initial pose for the manipulation.
...
to be filled
````
is the script showing how to adapt the public script [VG_PostAnimator](unity_component_vgpostanimator.0.14.0.html) to ...
