...
{% include tip.html content= "[VG_HandProfile](unity_component_vghandprofile.1.6.3.html) page gives detailed instruction on how to setup custom hands in Unity."%} 
