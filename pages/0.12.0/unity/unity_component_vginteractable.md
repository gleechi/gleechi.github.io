...
Adding VG_Interactable to an object will override the [global grasp interaction settings](unity_component_myvirtualgrasp.0.12.0.html#grasp-interaction-settings) for that particular object. 
