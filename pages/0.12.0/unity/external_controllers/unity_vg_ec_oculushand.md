...
permalink: unity_vg_ec_oculushand.0.12.0.html
...
Finally, you can use the "OCULUS_FT" option to [AutoSetup](unity_component_myvirtualgrasp.0.12.0.html#autosetup) your VG configuration. For this controller, AutoSetup 
