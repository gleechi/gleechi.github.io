...
permalink: unity_vgonboarding_task5.0.10.1.html
folder: mydoc
---
...
is the script showing how to use API function [ChangeObjectJoint](virtualgrasp_unityapi.0.10.1.html#changeobjectjoint) and [RecoverObjectJoint](virtualgrasp_unityapi.0.10.1.html#recoverobjectjoint) to attach and unattach the cap on to the bottle. 