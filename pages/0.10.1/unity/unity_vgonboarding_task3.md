...
permalink: unity_vgonboarding_task3.0.10.1.html
folder: mydoc
---
...
* When to form this joint? Should object be fully released by all grasping hands? Check out [OnObjectFullyReleased](virtualgrasp_unityapi.0.10.1.html#onobjectfullyreleased).
* How to pickup the object from the container again? Check out [OnObjectGrasped](virtualgrasp_unityapi.0.10.1.html#onobjectgrasped).
