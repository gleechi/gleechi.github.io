...
{% include callout.html content="If you do have a headset, we recommend to use the \"UNITYXR\" auto-setup (after assuring that you enabled your scene for VR) to get started, through [UnityXR](https://docs.unity3d.com/Manual/XR.0.13.0.html)." type="info" %}

<!--See [AutoSetup & Sensors](unity_component_myvirtualgrasp.0.13.0.html#autosetup--sensors) to learn more details about sensor setup.-->
