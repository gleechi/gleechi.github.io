...
permalink: unity_vgonboarding_task5.1.4.0.html
folder: mydoc
---
...
[VG_Assemble](unity_component_vgassemble.1.4.0.html) component is used for assembling and disassembling the cap to the bottle. 
...
* Because when assembled, cap is using  {% include tooltip.html tooltip="Revolute" text="revolute" %} joint with non-zero screw rate to simulate screwing effect of cap in the real world, a disabled [VG_Articulation](unity_component_vgarticulation.1.4.0.html) with  {% include tooltip.html tooltip="Revolute" text="revolute" %} joint is added to this game object and drag it to _Assemble Articulation_ entry.
