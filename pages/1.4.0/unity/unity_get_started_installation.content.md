...
| [Object Baking](object_baking.1.4.0.html) | ✔ | |
| [Grasp Editing](unity_component_vggraspeditor.1.4.0.html) | ✔ | |
| [Custom Hand Models](avatars.1.4.0.html#custom-hand-models) | ✔ | |
| [Replay Features](sensor_record_replay.1.4.0.html) | ✔ | |
| Commercial License | ✔ | |
...
There is only one minimal main component you have to add by default to use and configure VirtualGrasp: [MyVirtualGrasp.cs](unity_component_myvirtualgrasp.1.4.0.html). Adding a component to your scene and playing your scene, you should see some messages produced by the plugin in the Console Window.
...
{% include callout.html content="Initialized VirtualGrasp SDK (version 1.4.0-full)." %}
