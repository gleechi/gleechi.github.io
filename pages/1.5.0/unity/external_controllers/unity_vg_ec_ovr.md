...
permalink: unity_vg_ec_ovr.1.5.0.html
...
If these requirements are met, you will be able to use the **VG_CP_Oculus.OVRHand.HandTracking** controller profile to setup your [MyVirtualGrasp](unity_component_myvirtualgrasp.1.5.0.html#profile) configuration (otherwise an error will appear on the console).
