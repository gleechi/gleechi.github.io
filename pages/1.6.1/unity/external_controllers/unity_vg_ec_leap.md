...
permalink: unity_vg_ec_leap.1.6.1.html
...
If these requirements are met, you will be able to use the **VG_CP_UltraLeap.HandTracking** controller profile to setup your [MyVirtualGrasp](unity_component_myvirtualgrasp.1.6.1.html#profile) configuration (otherwise an error will appear on the console).
