...
permalink: unity_vg_ec_mousehand.0.9.6.html
...
There are no requirements to use this controller, so you can use the "MOUSE" option to [AutoSetup](unity_component_myvirtualgrasp.0.9.6.html#autosetup) your VG configuration.
