...
permalink: unity_vgonboarding_task5.0.11.0.html
folder: mydoc
---
...
is the script showing how to use API function [ChangeObjectJoint](virtualgrasp_unityapi.0.11.0.html#changeobjectjoint) and [RecoverObjectJoint](virtualgrasp_unityapi.0.11.0.html#recoverobjectjoint) to attach and unattach the cap on to the bottle. 