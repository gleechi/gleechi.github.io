...
permalink: unity_component_vginteractable.0.11.0.html
folder: mydoc
---
...
All parameters in the VG_Interactable component are explained in [grasp interaction](grasp_interaction.0.11.0.html#grasp-interaction).

Adding VG_Interactable to an object will override the [global grasp interaction settings](unity_component_myvirtualgrasp.0.11.0.html#grasp-interaction-settings) for that particular object. 
