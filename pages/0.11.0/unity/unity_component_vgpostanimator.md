...
permalink: unity_component_vgpostanimator.0.11.0.html
folder: mydoc
---
...
during grasping by adding a listener to the [VG_Controller.OnPostUpdate](virtualgrasp_unityapi.0.11.0.html#onpostupdate) event.
