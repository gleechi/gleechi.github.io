...
In any VG_MainScript, such as [MyVirtualGrasp.cs](unity_component_myvirtualgrasp.0.11.0.html), a sensor setting can be configured for any {% include tooltip.html tooltip="Controller" text="controller" %} (or {% include tooltip.html tooltip="Sensor" text="sensor" %}) supported through various [VG_ExternalControllers](unity_component_vgexternalcontrollermanager.0.11.0.html).
...
{% include callout.html content="If you do have a headset, we recommend to use the \"UNITYXR\" auto-setup (after assuring that you enabled your scene for VR) to get started, through [UnityXR](https://docs.unity3d.com/Manual/XR.0.11.0.html)." type="info" %}

<!--See [AutoSetup & Sensors](unity_component_myvirtualgrasp.0.11.0.html#autosetup--sensors) to learn more details about sensor setup.-->
...
{% include image.html file="unity/unity_vg_myvirtualgrasp_0_10_1.png" alt="VG control flags." caption="MyVirtualGrasp is the default main configuration component for VirtualGrasp." %}