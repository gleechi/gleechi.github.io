...
permalink: unity_component_vgexternalcontrollermanager.0.10.0.html
folder: mydoc
---
...
It should be used in any VG_MainScript, such as [MyVirtualGrasp.cs](unity_component_myvirtualgrasp.0.10.0.html), where it is initialized after the VG_Controller itself initialized:
...
<!-- For more background information, please refer to the [Controller](controllers.0.10.0.html) explanation. -->
