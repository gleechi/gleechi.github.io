...
A set of ready-to-use controllers is explained in on the [VG_ExternalControllerManager](unity_component_vgexternalcontrollermanager.1.3.0.html#vg_externalcontroller-class) page. 
