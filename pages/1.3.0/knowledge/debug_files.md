...
keywords: vg_tmp
permalink: debug_files.1.3.0.html
folder: knowledge
toc: true
---
...
* One *.db* file carrying data filled with [VG_GraspEditor](unity_component_vggraspeditor.1.3.0.html) or [VG_BakingClient](unity_component_vgbakingclient.1.3.0.html).
...
A *.zip* file of all the content in *vg_tmp* folder is the input that is needed for [object baking](object_baking.1.3.0.html#upload-input).
