...
permalink: unity_component_vgpostanimator.1.0.0.html
folder: mydoc
---
...
during grasping by adding a listener to the [VG_Controller.OnPostUpdate](virtualgrasp_unityapi.1.0.0.html#vg_controlleronpostupdate) event.
