...
It should be used in any VG_MainScript, such as [MyVirtualGrasp.cs](unity_component_myvirtualgrasp.0.9.5.html), where it is initialized after the VG_Controller itself initialized:
...
<!-- For more background information, please refer to the [Controller](controllers.0.9.5.html) explanation. -->
...
* [VG_MouseHand](unity_vg_ec_mousehand.0.9.5.html) for Mouse control.
* [VG_UnityXRHand](unity_vg_ec_unityxrhand.0.9.5.html) for all XR controllers that are supported through [UnityXR](https://docs.unity3d.com/Manual/XR.0.9.5.html).
* [VG_OculusHand](unity_vg_ec_oculushand.0.9.5.html) for Oculus Finger Tracking which is supported through the Oculus SDK.
* [VG_MouseHand](unity_vg_ec_leaphand.0.9.5.html) for LeapMotion controller which is supported through the Ultraleap SDK.
* [VG_GenericHand](unity_vg_ec_generichand.0.9.5.html) as a fallback solution.
