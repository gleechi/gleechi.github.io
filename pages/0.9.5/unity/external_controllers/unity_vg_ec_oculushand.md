...
permalink: unity_vg_ec_oculushand.0.9.5.html
...
After this, use the "OCULUS_FT" option to [AutoSetup](unity_component_myvirtualgrasp.0.9.5.html#autosetup) your VG configuration.
