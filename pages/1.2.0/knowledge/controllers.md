...
A set of ready-to-use controllers is explained in on the [VG_ExternalControllerManager](unity_component_vgexternalcontrollermanager.1.2.0.html#vg_externalcontroller-class) page. 
...
| Hand Mappings | you can find a more detailed documentation on [Controller Axis Mappings](avatars.1.2.0.html#hand-profiles). | 
