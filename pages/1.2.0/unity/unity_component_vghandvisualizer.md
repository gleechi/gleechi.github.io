...
The MonoBehavior script exemplifies how to use the VG API functions for accessing specific bones / elements of the hands, such as [GetBone()](virtualgrasp_unityapi.1.2.0.html#vg_controllergetbone) and [GetFingerBone()](virtualgrasp_unityapi.1.2.0.html#vg_controllergetfingerbone).
