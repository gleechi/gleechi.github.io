...
4. You have in runtime [SetObjectSelectionWeight](virtualgrasp_unityapi.1.2.0.html#setobjectselectionweight) to value <=0. 
...
You can only runtime change object articulation by using API function [ChangeObjectJoint](virtualgrasp_unityapi.1.2.0.html#changeobjectjoint-1). See page [runtime changes](unity_component_vgarticulation.1.2.0.html#runtime-changes). 
