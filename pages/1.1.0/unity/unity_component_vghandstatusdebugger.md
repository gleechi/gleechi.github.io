...
permalink: unity_component_vghandstatusdebugger.1.1.0.html
folder: mydoc
---
...
The VG_HandStatusDebugger provides a tutorial on some of the members of [VG_HandStatus](unity_component_vghandstatus.1.1.0.html) which are central to many of the API functions, such as [GetHands()](virtualgrasp_unityapi.1.1.0.html#vg_controllergethands) or some [Events](virtualgrasp_unityapi.1.1.0.html#events).
