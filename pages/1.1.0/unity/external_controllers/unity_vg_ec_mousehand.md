...
permalink: unity_vg_ec_mousehand.1.1.0.html
...
There are no requirements to use this controller, so you can use the "VG_EC_MouseHand" controller profile to setup your [MyVirtualGrasp](unity_component_myvirtualgrasp.1.1.0.html#controller-profile) configuration.
