...
keywords: vg_tmp
permalink: debug_files.0.11.1.html
folder: knowledge
toc: true
---
...
The *.obj* files of all the objects are used for the automatic generation of the [grasp studio](unity_component_vggraspstudio.0.11.1.html) scene.
