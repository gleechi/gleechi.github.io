...
To create natural-looking {% include tooltip.html tooltip="GraspConfiguration" text="grasp configurations" %} during {% include tooltip.html tooltip="GraspSynthesisMethod" text="grasp synthesis" %}, we need to [bake the object](object_baking.0.11.1.html#object-baking).
...
[grasp studio](unity_component_vggraspstudio.0.11.1.html#grasp-studio) can be used to add grasps into database through DG. 
