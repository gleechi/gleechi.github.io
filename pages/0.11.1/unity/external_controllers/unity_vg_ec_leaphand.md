...
permalink: unity_vg_ec_leaphand.0.11.1.html
...
Finally, you can use the "LEAP_EXT" option to [AutoSetup](unity_component_myvirtualgrasp.0.11.1.html#autosetup) your VG configuration.
