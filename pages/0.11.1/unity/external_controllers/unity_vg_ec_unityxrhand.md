...
permalink: unity_vg_ec_unityxrhand.0.11.1.html
...
This is an external controller class that supports a [UnityXR](https://docs.unity3d.com/Manual/XR.0.11.1.html) controller (such as provided by Pico or Oculus integrations) as an external controller.
...
Finally, you can the "UNITY_XR" option to [AutoSetup](unity_component_myvirtualgrasp.0.11.1.html#autosetup) your VG configuration.
